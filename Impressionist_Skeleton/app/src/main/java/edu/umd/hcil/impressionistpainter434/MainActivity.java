...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String fileName = r.nextInt(9) + r.nextInt(9) + r.nextInt(9) + r.nextInt(9) + r.nextInt(9) + ".png";
                        ...
                        try {
                            ...
                            Toast.makeText(getApplicationContext(), "Image saved as " + fileName, Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void onButtonClickInvertColor(View v) {
        if (invert) {
            _impressionistView.invertBrush();
            Toast.makeText(getApplicationContext(), "Brush no longer inverted.", Toast.LENGTH_SHORT).show();
            invert = false;
        } else {
            _impressionistView.invertBrush();
            Toast.makeText(getApplicationContext(), "Brush inverted.", Toast.LENGTH_SHORT).show();
            invert = true;
        }
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuSquare:
                ...
                return true;
            case R.id.menuIlluminati:
                Toast.makeText(this, "Spooky.", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Illuminati);
                return true;
            case R.id.menuSprayPaint:
                Toast.makeText(this, "Spray Paint Brush", Toast.LENGTH_SHORT).show();
